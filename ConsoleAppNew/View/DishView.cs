...
namespace ConsoleAppNew.View
{
    public class DishView
    {
        ...
        {
            //(int dishId, string name, decimal price, int restaurant, int ingredients)
            ...
            Dish employee = new Dish(dishId, name, price, resId, ingredients);
           DishController vasyaController = new DishController(employee);
